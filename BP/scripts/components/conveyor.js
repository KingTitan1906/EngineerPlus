...
const AreaChecking = {
    north: {
        north: {
            min: {x: 0.1, y: 0.12, z: -0.25},
            max: {x: 0.9, y: 0.25, z: 0.9}
        },
        south: {
            min: {x: 0.1, y: 0.12, z: 0.9},
            max: {x: 0.9, y: 0.25, z: 1.0}
        },
        west: {
            min: {x: 0.0, y: 0.12, z: 0.1},
            max: {x: 0.1, y: 0.25, z: 0.9}
        },
        east: {
            min: {x: 0.9, y: 0.12, z: 0.1},
            max: {x: 1.0, y: 0.25, z: 0.9}
        }
    },
    south: {
        north: {
            min: {x: 0.1, y: 0.12, z: 0.1},
            max: {x: 0.9, y: 0.25, z: 1.25}
        },
        south: {
            min: {x: 0.1, y: 0.12, z: 0.0},
            max: {x: 0.9, y: 0.25, z: 0.1}
        },
        west: {
            min: {x: 0.9, y: 0.12, z: 0.1},
            max: {x: 1.0, y: 0.25, z: 0.9}
